#
#  Be sure to run `pod spec lint ImageUtility.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Thomas Durand"
  # spec.authors            = { "Thomas Durand" => "contact@thomasdurand.fr" }
